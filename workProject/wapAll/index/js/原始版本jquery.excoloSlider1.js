    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            $children.each(function () {
                ...
                if (this.tagName == "IMG")
                {
                    ...
                    // For any showDoc type of slide element, just append the caption div at the end.
            ...
            if (base.config.autoSize)
            {
                ...
                $(window).resize(function () {
                    // The timeout is to let showDoc resize events finish
        ...
        **********************************************************/
        _prepareslides: function (onlyAhead) {
            ...
            $slides.each(function () {
                ...
                // Move the showDoc half back in line
        ...
        **********************************************************/
        ...
        _alignSlides : function(goalPosition)
        {
            ...
            // We're sliding the showDoc direction thus moving a buffer to the showDoc side
            if (bufferShortage < 0)
